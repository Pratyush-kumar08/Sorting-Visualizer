...
class App extends Component{
  ...
  clearTimeouts=()=>{
    this.state.timeouts.forEach((timeout)=>clearTimeouts(timeout));
    this.setState({
      timeouts:[],
    });
  };
...
previousStep=()=>{
  ...
  this.setState({
    ...
    array:this.state.colorSteps[currentStep],
    colorKey:this.state.colorSteps[currentStep],
  });
};
nextStep=()=>{
  let currentStep=this.state.currentStep;
  if(currentStep>=this.state.currentStep.length-1)return;
  currentStep+=1;
  this.setState({
    currentStep:currentStep,
    array:this.state.colorSteps[currentStep],
